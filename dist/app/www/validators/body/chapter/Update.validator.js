...
var ChapterUpdateValidator = _joi["default"].object({
  name: _joi["default"].string(),
  number: _joi["default"].number().min(0),
  content: _joi["default"].string(),
  isFree: _joi["default"]["boolean"](),
  privateEnd: _joi["default"].date(),
  price: _joi["default"].number().min(0),
  StoryId: _joi["default"].number(),
...
var _default = exports["default"] = ChapterUpdateValidator;