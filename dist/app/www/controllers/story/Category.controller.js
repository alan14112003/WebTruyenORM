...
var _CategoryKey = _interopRequireDefault(require("../../../enums/redis_key/CategoryKey.enum"));
...
var CategoryController = {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _Redis["default"].get(_CategoryKey["default"].ALL);
          case 3:
          ...
          case 7:
            categories = _context.sent;
          case 8:
            _Redis["default"].set(_CategoryKey["default"].ALL, categories);
  ...
  get: function () {
    var _get = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
      var id, redisKey, category;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            id = req.params.id;
            redisKey = "".concat(_CategoryKey["default"].GET, ".").concat(id);
            _context2.next = 5;
          ...
          case 9:
            category = _context2.sent;
          case 10:
            _Redis["default"].set(redisKey, category);
            return _context2.abrupt("return", res.status(200).json(category));
          case 14:
            _context2.prev = 14;
        ...
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            body.forEach(function (category) {
              category.slug = (0, _Slugify["default"])(category.name);
            });
            _context3.next = 9;
            return _Category["default"].bulkCreate(body, {
              transaction: trx
            });
          case 9:
            data = _context3.sent;
          ...
          case 12:
            ...
            _context3.next = 15;
            return _Category["default"].create(body, {
              transaction: trx
            });
          case 15:
            data = _context3.sent;
          case 16:
            _Redis["default"].del(_CategoryKey["default"].ALL);
            trx.commit();
  ...
  update: function () {
    var _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
      var id, category, _yield$Category$updat, _yield$Category$updat2, updatedCount;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            category.slug = (0, _Slugify["default"])(category.name);
            _context4.next = 6;
            return _Category["default"].update(category, {
              where: {
                id: id
              }
            });
          case 6:
            ...
            updatedCount = _yield$Category$updat2[0];
            if (updatedCount) {
              _Redis["default"].del(_CategoryKey["default"].ALL);
              _Redis["default"].del("".concat(_CategoryKey["default"].GET, ".").concat(id));
            }
...
var _default = exports["default"] = CategoryController;