...
var _AuthorKey = _interopRequireDefault(require("../../../enums/redis_key/AuthorKey.enum"));
...
var AuthorController = {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _Redis["default"].get(_AuthorKey["default"].ALL);
          case 3:
            ...
            _context.next = 7;
            return _Author["default"].findAll();
          case 7:
            authors = _context.sent;
          case 8:
            _Redis["default"].set(_AuthorKey["default"].ALL, authors);
            return _context.abrupt("return", res.status(200).json(authors));
          case 12:
            _context.prev = 12;
  ...
  get: function () {
    var _get = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
      var id, redisKey, author;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            id = req.params.id;
            redisKey = "".concat(_AuthorKey["default"].GET, ".").concat(id);
            _context2.next = 5;
          ...
          case 5:
            ...
            _context2.next = 9;
            return _Author["default"].findOne({
              where: {
                id: id
              }
            });
          case 9:
            author = _context2.sent;
          case 10:
            _Redis["default"].set(redisKey, author);
            return _context2.abrupt("return", res.status(200).json(author));
          case 14:
            _context2.prev = 14;
        ...
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            body.forEach(function (author) {
              author.slug = (0, _Slugify["default"])(author.name);
            });
            _context3.next = 9;
            return _Author["default"].bulkCreate(body, {
              transaction: trx
            });
          case 9:
            data = _context3.sent;
          ...
          case 12:
            ...
            _context3.next = 15;
            return _Author["default"].create(body, {
              transaction: trx
            });
          case 15:
            data = _context3.sent;
          case 16:
            _Redis["default"].del(_AuthorKey["default"].ALL);
            trx.commit();
  ...
  update: function () {
    var _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
      var id, author, _yield$Author$update, _yield$Author$update2, updatedCount;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 6:
            _yield$Author$update = _context4.sent;
            _yield$Author$update2 = _slicedToArray(_yield$Author$update, 1);
            updatedCount = _yield$Author$update2[0];
            if (updatedCount) {
              _Redis["default"].del(_AuthorKey["default"].ALL);
              _Redis["default"].del("".concat(_AuthorKey["default"].GET, ".").concat(id));
            }
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return _Author["default"].destroy({
              where: {
                id: id
              }
            });
...
var _default = exports["default"] = AuthorController;